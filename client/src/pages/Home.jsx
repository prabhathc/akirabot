    ...
    <div>
      <main>
        <div className="mx-auto max-w-3xl px-6 relative h-screen flex-col">
                <div className="absolute inset-x-0 -z-10 transform-gpu overflow-hidden blur-3xl top-0 invisible md:visible">
                  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="50" cy="50" r="50" fill="#A9D2EF" />
                  </svg>
                </div>
                ...
                <h1 className="text-5xl font-bold tracking-tight sm:text-center sm:text-6xl text-pillblue sm:text-pillwhite">
                  Your one stop shop for endless music.
                </h1>
                <div className="mt-8 flex gap-x-4 sm:justify-center invisible sm:visible">
                  <a
                    href="#"
                ...
                <div className="mt-8 flex gap-x-4 sm:justify-center visible sm:invisible">
                  <a
                    href="#"
                    className="inline-block rounded-lg bg-pillblue/20 px-4 py-2 text-lg font-semibold leading-7 text-pillblue shadow-sm ring-1 ring-pillblue/20 hover:ring-pillblue duration-300"
                  >
                    Get started
                    {' '}
                    <span className="text-pillblue" aria-hidden="true">
                      &rarr;
                    </span>
                  </a>
                  <button onClick={() => learnMoreData.current.scrollIntoView({behavior: 'smooth'})} className="inline-block rounded-lg px-4 py-2 text-lg font-semibold leading-7 text-pillblue ring-1 ring-pillblue/20 hover:ring-pillblue duration-300 cursor-pointer">
                    Learn more
                      {' '}
                    <span className="text-pillblue" aria-hidden="true">
                      &rarr;
